...
INSERT INTO status (id, status) VALUES (0, 'REJECTED') ON CONFLICT (id) DO NOTHING;
INSERT INTO status (id, status) VALUES (0, 'PENDING') ON CONFLICT (id) DO NOTHING;
INSERT INTO status (id, status) VALUES (0, 'ON_COURSE') ON CONFLICT (id) DO NOTHING;
INSERT INTO status (id, status) VALUES (0, 'TERMINATED') ON CONFLICT (id) DO NOTHING;
